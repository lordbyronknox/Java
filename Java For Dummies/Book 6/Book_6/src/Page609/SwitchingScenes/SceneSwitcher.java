 ...
 */
package Page609.SwitchingScenes;
...
//VBox layout pane arranges the controls vertically.
        VBox pane1 = new VBox(10);          
        pane1.getChildren().addAll(lblClicks, btnClickMe, btnSwitchToScene2);
//create a the scene, using pane1 as its root.
...
//Layout pane created using HBox class, with 10pixels between the controls.
        HBox pane2 = new HBox(10);
//Add controls to the layout pane (pane2)
