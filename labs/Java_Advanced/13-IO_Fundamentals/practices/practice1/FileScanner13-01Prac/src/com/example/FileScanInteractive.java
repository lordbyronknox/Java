...
public class FileScanInteractive {
    ...
    public static void main(String[] args) {
        ...
        //save first arg passed into the app as a string.
        String file = args[0];
        //create an instance of FileScanInteractive - to call the countTokens method...
        FileScanInteractive scan = new FileScanInteractive();
        //6. open ststem console for input using a buffer reader.
        try (
