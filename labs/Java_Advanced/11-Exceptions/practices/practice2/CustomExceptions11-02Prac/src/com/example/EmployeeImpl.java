...
public class EmployeeImpl {
    ...
    public void add(Employee emp) throws InvalidOperationException {
        if (employeeArray[emp.getId()] != null) {
            throw new InvalidOperationException("Error adding employee , "
        ...
        try {
            ...
            throw new InvalidOperationException(
                    "Error adding employee , id must be less than " + employeeArray.length);
        }
    }

    public void delete(int id) throws InvalidOperationException {
        if (employeeArray[id] == null) {
            throw new InvalidOperationException("Error deleting employee, "
                    + "no such employee" + id);
        }
        try {
